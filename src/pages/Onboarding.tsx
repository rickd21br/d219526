...
import headlineFuturo from "@/assets/headline-futuro.png";
    ...
    <div className="fixed inset-0 overflow-y-auto">
      ...
      >
        ...
        <div className="mt-5 flex w-full flex-col items-center space-y-3 pt-2">
          ...
          />
          <p className="flex w-full items-center gap-2 self-stretch pt-2 text-left text-[12px] leading-snug text-white/75">
